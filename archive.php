		...
		<section id="main" role="main">
			...
			<header class="page-header">
				...
				if(is_day()) : ?>
					...
					<h1 class="page-title">
						<?php printf(__('Daily Archives: <span>%s</span>', 'inception'), get_the_time(get_option('date_format'))); ?>
					</h1>
				...
				elseif(is_month()) : ?>
					...
					<h1 class="page-title">
						<?php printf(__('Monthly Archives: <span>%s</span>', 'inception'), get_the_time('F Y')); ?>
					</h1>
				...
				elseif(is_year()) : ?>
					...
					<h1 class="page-title">
						<?php printf(__('Yearly Archives: <span>%s</span>', 'inception'), get_the_time('Y')); ?>
					</h1>
				...
				elseif(isset($_GET['paged']) && !empty($_GET['paged'])) : ?>
					...
					<h1 class="page-title">
						<?php _e('Blog Archives', 'inception'); ?>
					</h1>
