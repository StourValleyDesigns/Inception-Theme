	...
	<div class="inner">
		...
		<section id="content">
			...
			if(have_posts()) : ?>
				...
				<h1 class="page-title">
					<?php _e('Search Results for: ', 'inception'); ?>
			...
			<?php //Else if no posts
				...
				<div id="post-0">
					<h2 class="entry-title">
						<?php _e('Nothing Found', 'inception'); ?>
					</h2>
					<div class="entry-content">
						<p>
							<?php _e('Sorry, but nothing matched your search criteria. Please try again with some different keywords.', 'inception'); ?>
						</p>
					</div>
				</div>
